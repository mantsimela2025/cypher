# PowerShell script to convert all .md files in /docs to .pdf using Pandoc with wkhtmltopdf
# Author: Generated for CYPHER project

$PandocPath = "C:\Program Files\Pandoc\pandoc.exe"
$WkhtmltopdfPath = "C:\Program Files\wkhtmltopdf\bin\wkhtmltopdf.exe"
$DocsPath = ".\docs"
$OutputPath = ".\docs-pdf-final"
...
function Convert-MarkdownToPdf {
    ...
    try {
        ...
        & $PandocPath -f markdown -t pdf --pdf-engine="$WkhtmltopdfPath" -o $OutputFile $InputFile
...
Write-Host "PDF Engine: $WkhtmltopdfPath" -ForegroundColor Yellow
Write-Host ""
