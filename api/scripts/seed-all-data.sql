-- =====================================================
-- Complete Systems and Assets Seed Data SQL Script
-- =====================================================
-- This script creates both systems and assets with complete data
...
('SYS-001', 'Corporate Network Infrastructure', gen_random_uuid(), 'operational', 'Infrastructure', 'IT Department', 'John Smith', 'Jane Doe', 'Mike Johnson', 'moderate', 'moderate', 'high', 'Core network infrastructure including servers, switches, routers, and network services', NOW(), NOW()),
('SYS-002', 'Web Application Platform', gen_random_uuid(), 'operational', 'Application', 'Development Team', 'Sarah Wilson', 'Jane Doe', 'Mike Johnson', 'high', 'high', 'moderate', 'Web applications, application servers, and related web services', NOW(), NOW()),
('SYS-003', 'Database Management System', gen_random_uuid(), 'operational', 'Database', 'Data Team', 'Bob Anderson', 'Jane Doe', 'Mike Johnson', 'high', 'high', 'high', 'Database servers and data management systems', NOW(), NOW()),
('SYS-004', 'Employee Workstation Environment', gen_random_uuid(), 'operational', 'Workstation', 'IT Department', 'John Smith', 'Jane Doe', 'Mike Johnson', 'moderate', 'moderate', 'moderate', 'Employee workstations, laptops, and end-user computing devices', NOW(), NOW()),
('SYS-005', 'Cloud Services Platform', gen_random_uuid(), 'operational', 'Cloud', 'Cloud Team', 'Lisa Chen', 'Jane Doe', 'Mike Johnson', 'moderate', 'moderate', 'moderate', 'Cloud-based resources, virtual machines, and cloud services', NOW(), NOW());

-- =====================================================
-- PART 2: ASSETS DATA
-- =====================================================

-- Insert Assets Data (20 comprehensive assets)
INSERT INTO assets (
    asset_uuid,
    hostname,
    netbios_name,
...
-- Infrastructure Assets (SYS-001) - 10 assets
...
(gen_random_uuid(), 'web-server-02', 'WEB-SERVER-02', 'SYS-001', true, true, NOW() - INTERVAL '150 days', NOW() - INTERVAL '2 days', 320, '5.8', 'medium', 'tenable', gen_random_uuid(), '{"acr_score":5.8,"criticality_rating":"medium","exposure_score":320,"has_agent":true,"hostname":["web-server-02"],"operating_system":["Windows Server 2022"],"system_type":["server"]}', NOW(), NOW()),
...
(gen_random_uuid(), 'app-server-02', 'APP-SERVER-02', 'SYS-001', false, true, NOW() - INTERVAL '120 days', NOW() - INTERVAL '3 days', 290, '4.9', 'low', 'tenable', gen_random_uuid(), '{"acr_score":4.9,"criticality_rating":"low","exposure_score":290,"has_agent":false,"hostname":["app-server-02"],"operating_system":["Ubuntu 22.04 LTS"],"system_type":["server"]}', NOW(), NOW()),
...
(gen_random_uuid(), 'dns-server-01', 'DNS-SERVER-01', 'SYS-001', true, true, NOW() - INTERVAL '210 days', NOW() - INTERVAL '1 day', 420, '6.0', 'medium', 'tenable', gen_random_uuid(), '{"acr_score":6.0,"criticality_rating":"medium","exposure_score":420,"has_agent":true,"hostname":["dns-server-01"],"operating_system":["CentOS 7"],"system_type":["server"]}', NOW(), NOW()),
(gen_random_uuid(), 'dhcp-server-01', 'DHCP-SERVER-01', 'SYS-001', false, true, NOW() - INTERVAL '140 days', NOW() - INTERVAL '5 days', 260, '4.2', 'low', 'tenable', gen_random_uuid(), '{"acr_score":4.2,"criticality_rating":"low","exposure_score":260,"has_agent":false,"hostname":["dhcp-server-01"],"operating_system":["Ubuntu 20.04 LTS"],"system_type":["server"]}', NOW(), NOW()),
(gen_random_uuid(), 'backup-server-01', 'BACKUP-SERVER-01', 'SYS-001', true, true, NOW() - INTERVAL '170 days', NOW() - INTERVAL '2 days', 340, '5.1', 'medium', 'tenable', gen_random_uuid(), '{"acr_score":5.1,"criticality_rating":"medium","exposure_score":340,"has_agent":true,"hostname":["backup-server-01"],"operating_system":["Windows Server 2022"],"system_type":["server"]}', NOW(), NOW()),

-- Application Platform Assets (SYS-002) - 5 assets
...
(gen_random_uuid(), 'node-app-01', 'NODE-APP-01', 'SYS-002', true, true, NOW() - INTERVAL '110 days', NOW() - INTERVAL '1 day', 540, '6.4', 'high', 'tenable', gen_random_uuid(), '{"acr_score":6.4,"criticality_rating":"high","exposure_score":540,"has_agent":true,"hostname":["node-app-01"],"operating_system":["Ubuntu 22.04 LTS"],"system_type":["server"]}', NOW(), NOW()),
(gen_random_uuid(), 'python-app-01', 'PYTHON-APP-01', 'SYS-002', true, false, NOW() - INTERVAL '125 days', NOW() - INTERVAL '4 days', 310, '4.7', 'medium', 'tenable', gen_random_uuid(), '{"acr_score":4.7,"criticality_rating":"medium","exposure_score":310,"has_agent":true,"hostname":["python-app-01"],"operating_system":["Ubuntu 20.04 LTS"],"system_type":["server"]}', NOW(), NOW()),

-- Database Assets (SYS-003) - 2 assets
...
-- Workstation Assets (SYS-004) - 2 assets
