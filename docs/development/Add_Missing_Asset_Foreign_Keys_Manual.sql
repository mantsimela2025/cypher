...
RAISE NOTICE 'Step 1: Cleaning up orphaned data before adding foreign key constraints...';
...
RAISE NOTICE 'Step 1 Complete: Orphaned data cleaned up.';

-- =====================================================
-- STEP 2: ADD MISSING FOREIGN KEY CONSTRAINTS
-- =====================================================

RAISE NOTICE 'Step 2: Adding missing foreign key constraints...';
...
RAISE NOTICE 'Step 2 Complete: All missing foreign key constraints added.';

-- =====================================================
-- STEP 3: VERIFICATION
-- =====================================================

RAISE NOTICE 'Step 3: Verifying foreign key constraints...';
...
RAISE NOTICE '==============================================';
RAISE NOTICE 'SUCCESS: All missing foreign key constraints have been added!';
RAISE NOTICE 'Your ERD should now show all relationships between:';
RAISE NOTICE '- Assets table connected to all asset management tables';
RAISE NOTICE '- Users table connected to audit fields';
RAISE NOTICE '- Asset groups connected to asset group members';
RAISE NOTICE '- STIG assets connected to main assets table';
RAISE NOTICE '==============================================';
...
-- =====================================================
/*
-- Uncomment and run this section if you need to remove the foreign keys:

ALTER TABLE "asset_cost_management" DROP CONSTRAINT IF EXISTS "asset_cost_management_asset_uuid_fkey";
ALTER TABLE "asset_cost_management" DROP CONSTRAINT IF EXISTS "asset_cost_management_created_by_fkey";
ALTER TABLE "asset_cost_management" DROP CONSTRAINT IF EXISTS "asset_cost_management_last_modified_by_fkey";
ALTER TABLE "asset_lifecycle" DROP CONSTRAINT IF EXISTS "asset_lifecycle_asset_uuid_fkey";
ALTER TABLE "asset_operational_costs" DROP CONSTRAINT IF EXISTS "asset_operational_costs_asset_uuid_fkey";
ALTER TABLE "asset_groups" DROP CONSTRAINT IF EXISTS "asset_groups_asset_uuid_fkey";
ALTER TABLE "asset_groups" DROP CONSTRAINT IF EXISTS "asset_groups_created_by_fkey";
ALTER TABLE "asset_group_members" DROP CONSTRAINT IF EXISTS "asset_group_members_group_id_fkey";
ALTER TABLE "asset_group_members" DROP CONSTRAINT IF EXISTS "asset_group_members_asset_uuid_fkey";
ALTER TABLE "asset_risk_mapping" DROP CONSTRAINT IF EXISTS "asset_risk_mapping_asset_uuid_fkey";
ALTER TABLE "asset_risk_mapping" DROP CONSTRAINT IF EXISTS "asset_risk_mapping_verified_by_fkey";
ALTER TABLE "stig_assets" DROP CONSTRAINT IF EXISTS "stig_assets_asset_uuid_fkey";
*/
